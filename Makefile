...
HTTPS_GIT := github.com/mygithub/mychain14.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=mychain14 \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c mychain14 --local -f chains.yaml
endif
